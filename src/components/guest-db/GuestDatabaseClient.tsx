    ...
    <div>
      ...
      {summary && (
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
          <div className="bg-white border border-resort-sand/80 border-l-4 border-l-resort-forest rounded-lg p-3 shadow-xs">
            <div className="flex items-center gap-2 mb-1">
              <Users className="h-3.5 w-3.5 text-resort-forest" />
              <span className="text-[10px] font-semibold text-resort-muted uppercase tracking-wider">Total Guests</span>
            </div>
            <div className="text-xl font-serif font-bold text-resort-charcoal">{summary.totalGuests.toLocaleString()}</div>
          </div>
          <div className="bg-white border border-resort-sand/80 border-l-4 border-l-emerald-600 rounded-lg p-3 shadow-xs">
            <div className="flex items-center gap-2 mb-1">
              <Bed className="h-3.5 w-3.5 text-emerald-600" />
              <span className="text-[10px] font-semibold text-emerald-800 uppercase tracking-wider">In House</span>
            </div>
            <div className="text-xl font-serif font-bold text-emerald-950">{summary.currentlyStaying}</div>
          </div>
          <div className="bg-white border border-resort-sand/80 border-l-4 border-l-resort-gold rounded-lg p-3 shadow-xs">
            <div className="flex items-center gap-2 mb-1">
              <Calendar className="h-3.5 w-3.5 text-resort-gold" />
              <span className="text-[10px] font-semibold text-resort-charcoal uppercase tracking-wider">Upcoming</span>
            </div>
            <div className="text-xl font-serif font-bold text-resort-charcoal">{summary.upcomingBookings}</div>
          </div>
          <div className="bg-white border border-resort-sand/80 border-l-4 border-l-resort-olive rounded-lg p-3 shadow-xs">
            <div className="flex items-center gap-2 mb-1">
              <TrendingUp className="h-3.5 w-3.5 text-resort-olive" />
              <span className="text-[10px] font-semibold text-resort-muted uppercase tracking-wider">Total Billed</span>
            </div>
            <div className="text-lg font-serif font-bold text-resort-charcoal">{formatINR(summary.totalBilled)}</div>
          </div>
          <div className="bg-white border border-resort-sand/80 border-l-4 border-l-resort-forest-light rounded-lg p-3 shadow-xs">
            <div className="flex items-center gap-2 mb-1">
