    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
        ...
        <Link href="/admin/bookings" className="block group">
          <Card className="hover:border-resort-forest transition-colors shadow-xs border-l-4 border-l-resort-forest h-full bg-white">
            <CardHeader className="p-3.5 pb-1">
              <CardDescription className="text-[10px] uppercase tracking-wider font-semibold text-resort-muted flex items-center justify-between">
                ...
                <CalendarDays className="w-3.5 h-3.5 text-resort-forest group-hover:scale-110 transition-transform" />
              </CardDescription>
              <CardTitle className="text-xl font-serif font-bold text-resort-charcoal mt-1">
                {kpis.totalReservations}
              </CardTitle>
            </CardHeader>
            <CardContent className="p-3.5 pt-1 text-[11px] text-resort-muted group-hover:text-resort-forest transition-colors">
        ...
        <Link href="/admin/bookings?status=CONFIRMED" className="block group">
          <Card className="hover:border-emerald-600 transition-colors shadow-xs border-l-4 border-l-emerald-600 h-full bg-white">
            <CardHeader className="p-3.5 pb-1">
              ...
              <CardTitle className="text-xl font-serif font-bold text-emerald-950 mt-1">
                {kpis.confirmedCount}
              </CardTitle>
            </CardHeader>
            <CardContent className="p-3.5 pt-1 text-[11px] text-resort-muted group-hover:text-emerald-700 transition-colors">
        ...
        <Link href="/admin/bookings?status=PENDING" className="block group">
          <Card className="hover:border-amber-600 transition-colors shadow-xs border-l-4 border-l-amber-500 h-full bg-white">
            <CardHeader className="p-3.5 pb-1">
              ...
              <CardTitle className="text-xl font-serif font-bold text-amber-950 mt-1">
                {kpis.pendingCount}
              </CardTitle>
            </CardHeader>
            <CardContent className="p-3.5 pt-1 text-[11px] text-resort-muted group-hover:text-amber-700 transition-colors">
        ...
        <Link href="/admin/frontdesk/arrivals" className="block group">
          <Card className="hover:border-resort-gold transition-colors shadow-xs border-l-4 border-l-resort-gold h-full bg-white">
            <CardHeader className="p-3.5 pb-1">
              <CardDescription className="text-[10px] uppercase tracking-wider font-semibold text-resort-charcoal flex items-center justify-between">
                <span>Today's Arrivals</span>
                <LogIn className="w-3.5 h-3.5 text-resort-gold group-hover:scale-110 transition-transform" />
              </CardDescription>
              <CardTitle className="text-xl font-serif font-bold text-resort-charcoal mt-1">
                {kpis.todayArrivalsCount}
              </CardTitle>
            </CardHeader>
            <CardContent className="p-3.5 pt-1 text-[11px] text-resort-gold-dark font-medium hover:underline flex items-center gap-1">
        ...
        <Link href="/admin/frontdesk/departures" className="block group">
          <Card className="hover:border-resort-olive transition-colors shadow-xs border-l-4 border-l-resort-olive h-full bg-white">
            <CardHeader className="p-3.5 pb-1">
              <CardDescription className="text-[10px] uppercase tracking-wider font-semibold text-resort-charcoal flex items-center justify-between">
                <span>Today's Departures</span>
                <LogOut className="w-3.5 h-3.5 text-resort-olive group-hover:scale-110 transition-transform" />
              </CardDescription>
              <CardTitle className="text-xl font-serif font-bold text-resort-charcoal mt-1">
                {kpis.todayDeparturesCount}
              </CardTitle>
            </CardHeader>
            <CardContent className="p-3.5 pt-1 text-[11px] text-resort-olive-light font-medium hover:underline flex items-center gap-1">
