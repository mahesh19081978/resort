...
export function ReservationTable({ data, canCancel, canCheckIn }: ReservationTableProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="hidden md:block bg-white rounded-xl border border-resort-sand/80 shadow-sm overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead className="bg-resort-sand/30 text-resort-charcoal uppercase font-semibold text-[10px] tracking-wider border-b border-resort-sand/80">
              <tr>
                <th className="py-3.5 px-4">Reservation #</th>
                <th className="py-3.5 px-4">Guest</th>
                <th className="py-3.5 px-4">Stay Dates</th>
                <th className="py-3.5 px-4">Room Type</th>
                <th className="py-3.5 px-4 text-center">Rooms / Pax</th>
                <th className="py-3.5 px-4 text-right">Amount</th>
                <th className="py-3.5 px-4">Payment</th>
                <th className="py-3.5 px-4">Status</th>
                <th className="py-3.5 px-4">Stay / Physical</th>
                <th className="py-3.5 px-4 text-right">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-resort-sand/50 text-neutral-700">
