...
export function AdminReservationFilters({ roomTypes }: AdminReservationFiltersProps) {
  ...
  return (
    <div className="space-y-4 bg-white rounded-xl border border-resort-sand/80 p-4 shadow-sm">
      {/* Quick Filter Tabs & Refresh */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-resort-sand/60 pb-3">
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-medium whitespace-nowrap transition-colors ${
                  isActive
                    ? 'bg-resort-forest text-white shadow-xs font-semibold'
                    : 'text-stone-600 hover:text-resort-charcoal hover:bg-resort-sand/40'
                }`}
              >
                {tab.label}
              </button>
