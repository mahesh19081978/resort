...
export function ReportFilter({ currentPeriod, basePath }: ReportFilterProps) {
  ...
  return (
    <div className="relative inline-flex items-center gap-2">
      <div className="relative">
        ...
        {isOpen && (
          <div
            className="absolute right-0 mt-1.5 w-52 bg-white rounded-md shadow-lg border border-neutral-200 py-1.5 z-50"
            role="menu"
          >
      ...
      {showCustomModal && (
        <div className="flex items-center gap-1.5 bg-white px-3 py-1 rounded-md border border-neutral-300 shadow-sm text-xs">
          ...
          <button
            ...
            className="h-7 text-xs bg-resort-gold hover:bg-resort-sand text-white px-2.5 ml-1 rounded font-medium transition-colors disabled:opacity-60"
          >
            Apply
          </button>
        </div>
