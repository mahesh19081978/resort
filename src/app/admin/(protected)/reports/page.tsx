...
export default async function ReportsPage() {
  ...
  const reports: ReportCategory[] = [
    ...
    },
    {
      ...
      color: 'text-resort-gold-dark',
      bgColor: 'bg-resort-gold/15',
      borderColor: 'border-l-resort-gold',
    },
    {
      title: 'Reservations',
      ...
      color: 'text-resort-olive',
      bgColor: 'bg-resort-olive/15',
      borderColor: 'border-l-resort-olive',
    },
    {
      title: 'Arrivals',
