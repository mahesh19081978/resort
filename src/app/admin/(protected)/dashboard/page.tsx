...
export default async function AdminDashboardPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-resort-sand/80 pb-5">
        <div>
          <div className="flex items-center gap-2.5 flex-wrap">
            <h1 className="font-serif text-2xl sm:text-3xl font-bold tracking-tight text-resort-charcoal">
              Executive Resort Performance
            </h1>
            <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-resort-forest/10 text-resort-forest border border-resort-forest/20">
              <Building2 className="w-3 h-3 mr-1 text-resort-gold" />
              {propertyName} ({propertyCode})
            </span>
          </div>
          <p className="text-xs text-resort-muted mt-1.5 flex items-center gap-2 flex-wrap">
            <span className="inline-flex items-center text-resort-charcoal font-medium">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <Link href={`/admin/dashboard?period=${periodRange.period}`}>
            <Button size="sm" variant="outline" className="text-xs h-9 border-resort-sand bg-white text-resort-charcoal hover:bg-resort-sand/40">
              <RotateCw className="w-3.5 h-3.5 mr-1.5 text-resort-forest" /> Refresh
            </Button>
          </Link>
        </div>
      </div>
      ...
      {overview.financialKpis !== null && (
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <h2 className="text-xs uppercase font-bold tracking-wider text-resort-muted">
              Executive Performance Summary ({periodRange.label})
            </h2>
            <span className="text-[11px] text-resort-muted font-medium">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3.5">
            ...
            <Card className="border-l-4 border-l-resort-forest bg-white hover:shadow-md transition-shadow">
              <CardHeader className="p-4 pb-1">
                <CardDescription className="text-[10px] uppercase tracking-wider font-semibold text-resort-muted flex items-center justify-between">
                  <span>Total Revenue</span>
                  <CreditCard className="w-4 h-4 text-resort-forest" />
                </CardDescription>
                <CardTitle className="text-xl font-serif font-bold text-resort-charcoal mt-1">
              ...
              <CardContent className="p-4 pt-1">
                {financial?.totalRevenueGrowth !== null && financial?.totalRevenueGrowth !== undefined ? (
                  ...
                  <span className="text-[11px] text-resort-muted">{periodRange.label}</span>
                )}
                <p className="text-[10px] text-resort-muted mt-0.5">Rooms + Restaurant</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-resort-gold bg-white hover:shadow-md transition-shadow">
              ...
              <CardContent className="p-4 pt-1">
                ...
                <p className="text-[10px] text-resort-muted mt-0.5">Folio Room Charges</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-l-4 border-l-resort-olive bg-white hover:shadow-md transition-shadow">
              ...
              <CardContent className="p-4 pt-1">
                ...
                <p className="text-[10px] text-resort-muted mt-0.5">Settled POS & Bills</p>
              </CardContent>
            </Card>

            {/* KPI 4: ACTUAL OCCUPANCY RATE */}
            <Card className="border-l-4 border-l-resort-forest-light bg-white hover:shadow-md transition-shadow">
              <CardHeader className="p-4 pb-1">
                <CardDescription className="text-[10px] uppercase tracking-wider font-semibold text-resort-muted flex items-center justify-between">
                  <span>Actual Occupancy</span>
                  <Percent className="w-4 h-4 text-resort-forest-light" />
                </CardDescription>
                <CardTitle className="text-xl font-serif font-bold text-resort-charcoal mt-1">
              ...
              <CardContent className="p-4 pt-1">
                <p className="text-xs text-resort-charcoal font-medium">
                  {financial ? `${financial.occupiedRoomNights} / ${financial.availableRoomNights} nights` : '—'}
                </p>
                <p className="text-[10px] text-resort-muted mt-0.5">Actual stays ÷ available</p>
              </CardContent>
            </Card>

            {/* KPI 5: ADR (Average Daily Rate) */}
            <Card className="border-l-4 border-l-resort-gold-dark bg-white hover:shadow-md transition-shadow">
              <CardHeader className="p-4 pb-1">
                <CardDescription className="text-[10px] uppercase tracking-wider font-semibold text-resort-muted flex items-center justify-between">
                  <span>ADR</span>
                  <TrendingUp className="w-4 h-4 text-resort-gold-dark" />
                </CardDescription>
                <CardTitle className="text-xl font-serif font-bold text-resort-charcoal mt-1">
                  {renderMetric(
              ...
              <CardContent className="p-4 pt-1">
                <p className="text-xs text-resort-charcoal font-medium">Average Daily Rate</p>
                <p className="text-[10px] text-resort-muted mt-0.5">Rev ÷ Occupied Nights</p>
              </CardContent>
            </Card>

            {/* KPI 6: RevPAR */}
            <Card className="border-l-4 border-l-resort-olive-light bg-white hover:shadow-md transition-shadow">
              <CardHeader className="p-4 pb-1">
                <CardDescription className="text-[10px] uppercase tracking-wider font-semibold text-resort-muted flex items-center justify-between">
                  <span>RevPAR</span>
                  <TrendingUp className="w-4 h-4 text-resort-olive-light" />
                </CardDescription>
                <CardTitle className="text-xl font-serif font-bold text-resort-charcoal mt-1">
                  {renderMetric(
                    overview.financialKpis,
              ...
              <CardContent className="p-4 pt-1">
                <p className="text-xs text-resort-charcoal font-medium">Rev Per Room</p>
                <p className="text-[10px] text-resort-muted mt-0.5">Rev ÷ Available Nights</p>
              </CardContent>
            </Card>
          </div>
        </div>
